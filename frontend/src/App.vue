  ...
  <div id="app" class="min-h-screen bg-gray-50">
        ...
        <div class="flex justify-between h-16">
          <div class="flex">
            ...
            <div class="flex-shrink-0 flex items-center">
              <router-link to="/" class="text-2xl font-bold gradient-primary bg-clip-text text-transparent">
                DSM Parts Finder
              </router-link>
            </div>
            ...
            <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
              <router-link
                ...
                :class="{ 'border-primary-500 text-primary-600': $route.name === 'Home' }"
              >
                Home
              </router-link>
              <router-link
                to="/parts"
                class="border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-2 px-1 border-b-2 font-medium text-sm transition-colors duration-200"
                :class="{ 'border-primary-500 text-primary-600': $route.name === 'Parts' }"
              >
                Parts Catalog
              </router-link>
            </div>
          ...
          <div class="sm:hidden flex items-center">
            ...
            >
              ...
              <!-- Menu icon -->
              <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" v-if="!mobileMenuOpen">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
              </svg>
              <!-- Close icon -->
              <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" v-else>
      ...
      <div class="sm:hidden" id="mobile-menu" v-show="mobileMenuOpen">
        <div class="pt-2 pb-3 space-y-1">
          <router-link
            ...
            :class="$route.name === 'Home' ? 'bg-primary-50 border-primary-500 text-primary-700' : 'border-transparent text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300'"
          >
            Home
          </router-link>
          <router-link
            ...
            :class="$route.name === 'Parts' ? 'bg-primary-50 border-primary-500 text-primary-700' : 'border-transparent text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300'"
          >
            Parts Catalog
          </router-link>
        </div>
      ...
      <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col items-center justify-center space-y-2">
          <p class="text-sm text-gray-500">
            © 2024 DSM Parts Finder. Built with Vue 3 & Tailwind CSS.
          </p>
    ...
    <div v-if="loading" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50 flex items-center justify-center">
      <div class="bg-white p-6 rounded-lg shadow-xl flex flex-col items-center space-y-4">
        <div class="spinner w-8 h-8 border-4 border-primary-600"></div>
